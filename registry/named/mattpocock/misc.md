...
origin: false
genericSkillRef: mattpocock-misc
status: named
level: 3★
...
- timestamp: '2026-08-19T11:50:18Z'
  action: add
  contributor: unknown
  details: Added named skill mattpocock/misc
- timestamp: '2026-08-19T11:50:29Z'
  action: suite_ref_set
  contributor: unknown
  details: Set suiteRef=mattpocock/misc, genericSkillRef=mattpocock-misc via `gaia
    dev fuse`.
