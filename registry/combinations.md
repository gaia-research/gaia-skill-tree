...
| ◇ [mattpocock](../docs/u/mattpocock/)/grill-with-docs | Extra Skill | Evaluate Output, Plan and Decompose | 3★ |  |
...
| ◇ /grill-me | Extra Skill | Design Review, Self-Critique | 4★ | Enforces a strict questioning loop that prevents the agent from proceeding to implementation until all branches are resolved. |
| ◆ /grill-with-docs | Ultimate Skill | Grill Me, Ubiquitous Language, Document Editing | 5★ | Requires the agent to maintain a live glossary (CONTEXT.md) and generate ADRs for all non-trivial trade-offs discovered during the grill. |
...
| ◇ /prompt-optimization | Extra Skill | Evaluate Output, Generate Text | 4★ |  |
...
| ◇ /ubiquitous-language | Extra Skill | Extract Entities, Requirements Analysis | 4★ | Requires active persistence of terms and immediate conflict resolution during sessions. |
...
| ◇ /web-scrape | Extra Skill | Web Search, Parse HTML, Extract Entities | 3★ | Structured output mode required. |
