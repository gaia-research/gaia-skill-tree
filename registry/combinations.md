...
|---|---|---|---|---|
| ◇ [anonymous]/swarm-advanced | Extra Skill | Swarm Topology Management, Multi-Agent Debate | — |  |
...
| ◇ [anonymous]/sparc-methodology | Extra Skill | Workflow Automation, Plan and Decompose | — | Requires a workflow orchestration target (e.g. Airflow, Temporal) and access to its authoring API. |
...
| ◇ [anonymous]/flow-nexus-platform | Extra Skill | API Call, Tool Use | — |  |
...
| ◇ [anonymous]/open-design | Extra Skill | Code Generation, Visual Question Answering | — |  |
...
| ◇ [anonymous]/flow-nexus-neural | Extra Skill | Parallel Execution, Embed Text | — |  |
| ◇ [anonymous]/agentdb-advanced | Extra Skill | Vector Search, Memory Manage | — |  |
...
| ◇ [anonymous]/graphify | Extra Skill | Extract Entities, Logical Inference | — |  |
...
| ◇ [anonymous]/flow-nexus-swarm | Extra Skill | Plan and Execute, Route Intent, Tool Select | — | Requires extensive multi-system validation before level advancement. |
...
| ◇ [anonymous]/orchestkit-rag | Extra Skill | Retrieve, Chunk Document, Embed Text, Score Relevance, Tokenize, Rank | — |  |
