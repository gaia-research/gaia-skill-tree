...
| `--slate` | `#94a3b8` | Alias of `--rank-0`; 0★ Unawakened rank accent. Used for redacted / pre-named skill surfaces. |
...
Each rank emits four tokens in `docs/css/tokens.css` (generated by `scripts/generateCssTokens.py`):

| Token pattern | Example (0★) | Use |
|---|---|---|
| `--rank-N` | `--rank-0: #94a3b8` | Text / icon fill — also aliased as `--slate` for 0★ |
| `--rank-N-bg` | `--rank-0-bg: rgba(148,163,184,.12)` | Card tint overlay |
| `--rank-N-border` | `--rank-0-border: rgba(148,163,184,.4)` | Rank-tinted hairline |
| `--rank-N-edge` | `--rank-0-edge: rgba(148,163,184,.55)` | Glow / edge highlight at 55% alpha |
