...
| 8 | `fusion.html` | Skill Fusion | ✅ Done — Type/Branch model throughout, incl. `gaia fuse`/propose code samples now schema-accurate (`prerequisites`/`combinedFrom`, Type `fusion`) (editor pass closes #1479); "Proposing a New Fusion" batch YAML fixed off the deprecated `class` field to the real `grade`+`type` schema 048 | 004, 017, 018, 025, 029, editor-026wk, 048 |
