...
| 7 | `evidence-classes.html` | Evidence & Trust | ✅ Done — fixed two `--no-build` callouts 035; cleaned up Verifier-tier wording 043; synced `fusion-recipe` row and added a Trust Magnitude / Fusion Score distinction for the Yggdrasil III 0-TM ruling 047 | 004, 017, 018, 025, 035, 043, 047 |
