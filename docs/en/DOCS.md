...
| 3 | `cli-reference.html` | CLI Reference | ✅ Done — documented missing mutating dev verbs (`dev rm-evidence`, `dev rm`, `dev link`, `dev reclassify`, `dev update-named`, `dev build`) 039 | 002, 017, 018, 025, 034, 039 |
