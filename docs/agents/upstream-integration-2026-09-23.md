...
| [#1893](https://github.com/gaia-research/gaia-skill-tree/issues/1893) | [`garrytan/skill-autobench`](https://github.com/garrytan/gbrain/blob/v0.51.6.0/skills/skill-autobench/SKILL.md) | accepted | skill-performance-benchmarking | 2 | ESCALATE | Usage-grounded eval author is distinct, but lives only under GBrain root skills/ (not plugin/skills/), requires private brain conversation history and transcripts; verify installability and privacy before admission. |
...
| [#1896](https://github.com/gaia-research/gaia-skill-tree/issues/1896) | [`garrytan/skillify`](https://github.com/garrytan/gbrain/blob/v0.51.6.0/skills/skillify/SKILL.md) | deferred | garrytan/skillify (existing gstack identity) / skill-authoring | — | ESCALATE | Canonical ID collision: existing garrytan/skillify points to gstack scrape-to-script skill (different source and behavior), while GBrain skillify is a 15-step general authoring/eval workflow; choose canonical naming/identity and whether it supersedes existing record. |
...
| deferred | 3 |
| omitted | 14 |
| ESCALATE (cross-cutting flag) | 31 |
