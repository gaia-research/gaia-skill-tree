...
- **Phase 2B — `ev-benchmark-verification`:** verifies `benchmark-result` rows and candidate manifests against `registry/benchmark-sources.json`; unknown/candidate/registered/mirrored/incomplete sources do not score.
