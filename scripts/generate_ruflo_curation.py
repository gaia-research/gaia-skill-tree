...
<head>
  ...
  <title>Ruflo Meta-Curation Brief — Gaia Skill Tree</title>
...
<body>
  ...
  <header>
    ...
    <p>Curation plan for all <strong>ruvnet/ruflo</strong> skills → the registry</p>
    <p class="meta">
  ...
  <footer style="margin-top:3rem; padding-top:1rem; border-top:1px solid var(--border); color:var(--muted); font-size:.8rem;">
    Generated by <code>scripts/generate_ruflo_curation.py</code> · Gaia Skill Tree
  </footer>
