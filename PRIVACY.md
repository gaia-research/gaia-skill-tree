...
The registry is a static GitHub repository. We do not operate any backend server, database, or analytics service. The public website (`gaiaskilltree.com`) is a static site hosted on GitHub Pages and does not set tracking cookies or collect telemetry.
